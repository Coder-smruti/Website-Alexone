      ...
      {!exiting && (
        ...
        >
          ...
          <motion.div
            ...
            style={{ background: 'linear-gradient(90deg,transparent,rgba(180,180,60,0.5),transparent)' }}
          />
              ...
              {RESIDENTIAL_ENTRY_STACK.map((item, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-6">
                    <p className="mb-2 text-[10px] uppercase tracking-[0.38em] text-[#b4b43c]">
                      Residential
                    </p>
          ...
          <div className="relative z-10 flex max-w-4xl flex-col items-center text-center px-6">
            ...
            <motion.img
              ...
              style={{
                ...
                objectFit: 'contain',
                marginBottom: '2rem',
                filter: 'drop-shadow(0 0 24px rgba(180,180,60,0.5))',
              }}
            />
            ...
            <motion.p
              ...
              className="text-[10px] uppercase text-[#b4b43c] mb-6 font-light"
            ...
            <div className="flex items-end mb-8 overflow-hidden" style={{ gap: '0.02em' }}>
              {BRAND.map((letter, i) => (
                <motion.span
                  key={i}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={handleEnter}
              className="group relative overflow-hidden px-14 py-4 border border-white/30 text-white text-xs uppercase tracking-[0.45em] hover:border-[#b4b43c]/80 transition-colors duration-500"
            >
              <span className="relative z-10 group-hover:text-[#1c2408] transition-colors duration-500">
              ...
              <motion.div
                ...
                className="absolute inset-0 bg-[#b4b43c]"
              />
            </motion.button>
          </div>
        </motion.div>

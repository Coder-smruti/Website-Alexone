    ...
    <div className="pt-0">
      ...
      <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <motion.div
          ...
          style={{ background: 'linear-gradient(90deg,transparent,rgba(180,180,60,0.45),transparent)' }}
        />
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <motion.p
            ...
            className="text-[#b4b43c] text-[10px] uppercase mb-7 font-light"
          ...
          >
            <button
              ...
              className="group relative overflow-hidden px-11 py-4 bg-[#b4b43c] text-[#1c2408] text-xs uppercase tracking-[0.38em] hover:bg-[#c8c84e] transition-colors duration-400"
            >
              Explore Projects
            </button>
            <button
              onClick={() => onNavigate('contact')}
              className="px-11 py-4 border border-white/35 text-white text-xs uppercase tracking-[0.38em] hover:border-[#b4b43c]/70 hover:bg-white/5 transition-all duration-400"
            >
              Book Consultation
            </button>
          </motion.div>
        ...
        >
          ...
          <div className="w-px h-12 bg-gradient-to-b from-[#b4b43c]/60 to-transparent" />
        </motion.div>
      </section>
      ...
      <section className="py-32 bg-luxury-black px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-xl md:text-2xl font-serif text-luxury-ivory/70 leading-relaxed italic"
          >
        ...
        <div className="flex flex-col md:flex-row h-[80vh] w-full">
          {CATEGORIES.map((cat, idx) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-luxury-black/50 group-hover:bg-luxury-black/20 transition-colors duration-500" />
      ...
      <section className="py-32 bg-luxury-black px-6">
        <div className="container mx-auto">
          ...
          <div className="mt-20 text-center">
            <button 
              onClick={() => onNavigate('spaces')}
              className="group inline-flex items-center gap-4 text-xs uppercase tracking-[0.3em] text-luxury-gold hover:text-luxury-ivory transition-colors"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              <SectionHeading 
                ...
                light
              />
              <p className="text-luxury-black/70 text-lg font-light leading-relaxed mb-10">
              ...
              <button 
                ...
                className="px-10 py-4 border border-luxury-black/20 text-luxury-black text-xs uppercase tracking-[0.3em] hover:bg-luxury-black hover:text-luxury-ivory transition-all duration-500"
              >
                Explore Materials
              </button>
            </motion.div>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                'https://images.unsplash.com/photo-1617806118233-18e1674745be?auto=format&fit=crop&q=80&w=600'
              ].map((img, idx) => (
                <motion.div
                  key={idx}
      ...
      {/* Testimonial */}
      <section className="py-40 bg-luxury-black px-6 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none flex items-center justify-center">
          <h2 className="text-[20vw] font-serif text-white whitespace-nowrap">ALEXONE</h2>
        </div>
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-serif text-luxury-ivory mb-8 leading-tight">
      ...
      {/* Contact CTA */}
      <section className="py-32 bg-luxury-charcoal px-6">
        <div className="container mx-auto text-center">
          <SectionHeading title="Let’s Design Something Extraordinary" subtitle="Get Started" />
          <p className="text-luxury-ivory/60 max-w-xl mx-auto mb-12 font-light">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <button 
              onClick={() => onNavigate('contact')}
              className="px-12 py-5 bg-luxury-gold text-luxury-black text-xs uppercase tracking-[0.3em] hover:bg-luxury-ivory transition-all duration-500"
            >
              Get in Touch
            </button>
            <button 
              onClick={() => onNavigate('contact')}
              className="px-12 py-5 border border-white/20 text-luxury-ivory text-xs uppercase tracking-[0.3em] hover:bg-white/10 transition-all duration-500"
            >
              Book Consultation
            </button>
          </div>

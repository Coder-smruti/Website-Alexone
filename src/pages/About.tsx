      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mb-32">
          ...
          <motion.p 
            ...
            className="text-luxury-ivory/70 text-lg md:text-xl font-light leading-relaxed"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-luxury-ivory/60 text-lg font-light leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {values.map((value, idx) => (
            <motion.div
              ...
              className="p-10 border border-white/5 bg-luxury-charcoal/30 hover:border-luxury-gold/30 transition-colors duration-500"
            >
              <h4 className="text-xl font-serif text-luxury-gold mb-4">{value.title}</h4>
              <p className="text-sm text-luxury-ivory/50 font-light leading-relaxed">
                {value.desc}
              </p>
            </motion.div>
          ))}

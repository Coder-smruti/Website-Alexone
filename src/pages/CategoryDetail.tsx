  ...
  return (
    <div className="min-h-screen bg-luxury-black text-luxury-ivory">
      ...
      <section className="relative h-[70vh] w-full overflow-hidden flex items-end">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-luxury-black via-luxury-black/40 to-black/20" />
        ...
        <div className="relative z-10 container mx-auto px-6 pb-16">
          ...
          <motion.div
            ...
            style={{ background: 'linear-gradient(90deg,#b4b43c,transparent)' }}
          />
          <motion.p
